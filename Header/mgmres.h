...
//
# define AlmostZero  1.0E-16

void atx_cr ( int n, int nz_num, int ia[], int ja[], double a[], double x[], double w[] );
void atx_st ( int n, int nz_num, int ia[], int ja[], double a[], double x[], double w[] );
void ax_cr ( int n, int nz_num, int ia[], int ja[], double a[], double x[], double w[] );
...
void pmgmres_ilu_cr ( int n, int nz_num, int ia[], int ja[], double a[], double x[], double rhs[], int itr_max, int mr, double tol_abs, double tol_rel );
